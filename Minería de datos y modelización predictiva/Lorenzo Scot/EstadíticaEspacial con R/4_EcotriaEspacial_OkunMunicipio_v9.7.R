...
MUNIC_ESP<-rgdal::readOGR(dsn="cartografías",layer="Munic04_ESP_GEO_ETRS89_DAT", stringsAsFactors = FALSE)
...
col.knn <- knearneigh(coords, k=4) # Aquí estaría seleccionando los 4 vecinos más cercanos
...
dinv_dist <- lapply(dist, function(x) 1/x)
