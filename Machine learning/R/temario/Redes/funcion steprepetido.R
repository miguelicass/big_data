...
# La función steprepetido realiza el proceso de seleccionar una submuestra 
# train de los datos para obtener un modelo vía selección stepwise (AIC o BIC)
# Cada modelo obtenido se guarda y se observan los modelos más frecuentes.
# 
# La salida es una lista de dos términos:
# 
# El primer término (pongamos lista[[1]]) es la tabla de frecuencias de los modelos
# con un contador de número de variables del modelos.
# 
# El segundo término (pongamos lista[[2]]) contiene la lista de variables 
# de cada modelo, por el orden de la tabla anterior, en formato dput
# para copiar y pegar en otras funciones de R. 
# lista[[2]][[1]] es el primer modelo de la tabla,
# lista[[2]][[2]] es el segundo modelo de la tabla, 
# etc.
