...
# Salida: Modelo num + categor sin 2 duplicadas y sin dos alta cardi.
# Comentarios: 
#-------------------
...
ggplot(impor_df, aes(fct_reorder(vars, Importance), Importance)) +
  ...
  theme_bw()
ggsave('./charts/04_evol_num_cat_nodup_2000.png')
...
# guardo submission
fwrite(my_sub, file = "./submissions/04_num_cat2000_nodup.csv" )
...
# 04 - 0.8122559 - num + cat (>1 & lga #150) no dup -  0.8156 
# 04 - 0.8138047 - num + cat (>1 & funder #200) no dup - 0.8156 
